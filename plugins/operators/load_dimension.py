...
class LoadDimensionOperator(BaseOperator):
    """
    Operator to Loads data to dimension table in Redshift
    
    :param redshift_conn_id: Redshift connection_ID
    :param table: Target table
    :param select_sql: SQL query
    :param append_insert: Whether append-insert or truncate-insert
    :param primary key: Verify if the row already exists 
    """
